      ...
      <div className="px-6 -mt-24 z-10">
         <div className="bg-white rounded-3xl p-5 shadow-xl shadow-blue-900/10 border border-white flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="mt-2 mb-6">
               ...
               <div className="flex items-center justify-center gap-2 mt-2 text-sm font-medium text-gray-500 bg-gray-50 px-3 py-1 rounded-full w-fit mx-auto">
                  <FiMapPin size={12} className={isClockedIn ? "text-emerald-500" : "text-gray-400"} />
                  <span>Office • 300m</span>
                  <FiRefreshCw size={10} className="ml-1 cursor-pointer hover:rotate-180 transition-all text-blue-400" />
               </div>
            </div>
