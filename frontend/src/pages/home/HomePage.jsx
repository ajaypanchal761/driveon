    ...
    <div className="min-h-screen w-full bg-white">
      ...
      <main className="px-4 md:px-6 lg:px-8 space-y-6 max-w-full md:max-w-7xl md:mx-auto" style={{ 
        ...
        <div className="hidden md:block">
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold mb-4" style={{ color: theme.colors.primary }}>
                  Why Choose DriveOn?
                </h2>
                ...
                {[
                  {
                    ...
                    title: 'Verified KYC',
                    description: 'Secure DigiLocker integration for verified identity',
                  },
                  {
                    icon: (
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    title: 'Live Tracking',
                    description: 'Real-time GPS tracking for safety and security',
                  },
                  {
                    icon: (
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    description: 'Pay full or 35% advance - choose what works for you',
                  },
                  {
                    icon: (
                      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    description: 'Earn points and discounts with our referral program',
                  },
                ].map((feature, index) => (
                  <div key={`feature-${index}`} className="text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-full mb-4" style={{ backgroundColor: `${theme.colors.primary}15`, color: theme.colors.primary }}>
                      {feature.icon}
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center">
                {[
                  ...
                  >
                    <span className="text-gray-700 font-semibold text-sm md:text-base">{partner}</span>
                  </div>
                ))}
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    answer: 'To book a car, you need to complete 100% of your profile including name, email, phone, age, gender, address, profile photo, and KYC verification through DigiLocker.',
                  },
                  {
                    question: 'What is KYC verification?',
                    answer: 'KYC (Know Your Customer) verification is done through DigiLocker OAuth2 integration. You need to verify your Aadhaar, PAN, and Driving License documents.',
                  },
                  {
                    question: 'Do I need a guarantor?',
                    answer: 'Yes, you need to add a guarantor who must also complete registration and KYC verification. The guarantor will receive an invite via email or phone.',
                  },
                  {
                    question: 'What payment options are available?',
                    answer: 'You can choose between full payment or 35% advance payment. The remaining amount will be auto-debited. We accept payments through Razorpay and Stripe.',
                  },
                  {
                    question: 'Is location tracking mandatory?',
                    answer: 'Yes, live GPS tracking is mandatory during active trips for safety and security. Location is tracked every 10 seconds and stored for 6 months.',
                  },
                  {
                    question: 'How does the referral program work?',
                    answer: 'Every user gets a referral code. When a new user signs up using your code and completes their first trip, you earn points that can be used as discounts.',
                  },
                ].map((faq, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <h3 className={`text-lg font-semibold pr-4 flex-1 ${isOpen ? '' : ''}`} style={{ color: theme.colors.primary }}>
                          {faq.question}
                        </h3>
                        <svg
          ...
          <section className="py-20 bg-gradient-to-r" style={{ background: `linear-gradient(135deg, ${theme.colors.primary} 0%, ${theme.colors.primaryDark} 100%)` }}>
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-white/90 text-lg lg:text-xl mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    Get the best car rental experience on your mobile. Book cars, track trips, and manage bookings on the go.
                  </p>
